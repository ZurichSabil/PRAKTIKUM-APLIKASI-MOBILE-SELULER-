<?php
// ============================================================
//  POST /api/pesanan.php  → buat pesanan baru
//  GET  /api/pesanan.php?user_id=X → ambil pesanan user
//  GET  /api/pesanan.php?nomor=RBxxxxxx → detail 1 pesanan
// ============================================================
...
//  Body: {
//    user_id, produk_id, model, warna, ukuran,
//    tanggal_mulai, tanggal_selesai, durasi_hari,
//    total_harga, metode_bayar
//  }
// ============================================================
