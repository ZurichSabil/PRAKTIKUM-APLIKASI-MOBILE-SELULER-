...
// ============================================================
//  GET /api/toko.php
//  Mengambil daftar toko beserta produk & variannya
//
//  Query params (opsional):
//    ?kota=Magelang          → filter berdasarkan kota
//    ?ukuran=M               → filter berdasarkan ukuran produk
//    ?harga_min=100000       → filter harga minimum
//    ?harga_max=300000       → filter harga maksimum
//    ?toko_id=4              → ambil 1 toko + semua produknya
// ============================================================
...
// ============================================================
//  Ambil daftar toko (dengan filter opsional)
// ============================================================
...
// ============================================================
//  Ambil produk untuk toko-toko di atas (dengan filter)
// ============================================================
...
// ============================================================
//  Ambil varian untuk semua produk
// ============================================================
if (!empty($produkList)) {
